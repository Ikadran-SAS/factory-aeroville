...
@php
    ...
    $blogPageSchema = [
        ...
        'name' => 'Blog – Factory & Co Aéroville',
        'description' => 'Conseils pratiques, guides et actualités Factory & Co Aéroville.',
...
<div class="page-hero">
    <div class="page-hero-inner">
        <h1>Blog –<br><em>Aéroville & Conseils</em></h1>
        <p>Conseils pratiques, astuces shopping, guides gastronomiques et informations pratiques pour votre visite à Aéroville.</p>
    </div>
</div>
